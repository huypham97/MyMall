...
public class CartItemModel {
    ...
    ////// cart item
    private String productID, productImage, productTitle, productPrice, cuttedPrice, selectedCouponId, discountedPrice;
    private Long freeCoupons, productQuantity, maxQuantity, stockQuantity, offersApplied, couponsApplied;
