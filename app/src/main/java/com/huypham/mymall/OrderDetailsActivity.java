...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = (TextView) findViewById(R.id.order_detail_product_title);
        price = (TextView) findViewById(R.id.order_detail_product_price);
        quantity = (TextView) findViewById(R.id.order_detail_product_quantity);
        productImage = (ImageView) findViewById(R.id.order_detail_product_image);

        orderedIndicator = (ImageView) findViewById(R.id.ordered_indicator);
        packedIndicator = (ImageView) findViewById(R.id.packed_indicator);
        shippedIndicator = (ImageView) findViewById(R.id.shipping_indicator);
        deliveredIndicator = (ImageView) findViewById(R.id.delivered_indicator);

        O_P_progress = (ProgressBar) findViewById(R.id.ordered_packed_progress);
        P_S_progress = (ProgressBar) findViewById(R.id.packed_shipping_progress);
        S_D_progress = (ProgressBar) findViewById(R.id.shipping_delivered_progress);

        orderedTitle = (TextView) findViewById(R.id.ordered_title);
        packedTitle = (TextView) findViewById(R.id.packed_title);
        shippedTitle = (TextView) findViewById(R.id.shipping_title);
        deliveredTitle = (TextView) findViewById(R.id.delivered_title);

        orderedDate = (TextView) findViewById(R.id.ordered_date);
        packedDate = (TextView) findViewById(R.id.packed_date);
        shippedDate = (TextView) findViewById(R.id.shipping_date);
        deliveredDate = (TextView) findViewById(R.id.delivered_date);

        orderedBody = (TextView) findViewById(R.id.ordered_body);
        packedBody = (TextView) findViewById(R.id.packed_body);
        shippedBody = (TextView) findViewById(R.id.shipping_body);
        deliveredBody = (TextView) findViewById(R.id.delivered_body);
        ...
        totalItemsPrice = (TextView) findViewById(R.id.total_item_price);
        deliveryPrice = (TextView) findViewById(R.id.delivery_price);
        savedAmount = (TextView) findViewById(R.id.saved_amount);
...
//        cancelDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        if (model.isCancellationRequested()) {
            ...
            cancelOrderBtn.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.colorWhite)));
        } else {
        ...
        if (!model.getCuttedPrice().equals("")) {
            if (!model.getDiscountedPrice().equals("")) {
                savedAmount.setText("You saved $" + String.valueOf(Long.valueOf(model.getCuttedPrice()) - Long.valueOf(model.getDiscountedPrice())) + " on this order.");
            } else {
                savedAmount.setText("You saved $" + String.valueOf(Long.valueOf(model.getCuttedPrice()) - Long.valueOf(model.getProductPrice())) + " on this order.");
            }
        } else {
            if (!model.getDiscountedPrice().equals("")) {
                savedAmount.setText("You saved $" + String.valueOf(Long.valueOf(model.getProductPrice()) - Long.valueOf(model.getDiscountedPrice())) + " on this order.");
            } else {
